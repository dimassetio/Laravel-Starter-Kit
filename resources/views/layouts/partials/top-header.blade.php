<div class="hidden-print" style="padding:10px 10px;vertical-align:middle">
    ...
    @endif
    <a class="logo-brand" title="{{ Option::get('app_name', 'PT. Chakra') }}" href="{{ route('home') }}">
        <img src="{{ url('assets/imgs/logo.png') }}" alt="Logo {{ Option::get('app_name', 'PT. Chakra') }}"
            width="60px">
        <h1>{{ Option::get('app_name', 'PT. Chakra') }}</h1>
    </a>
</div>
