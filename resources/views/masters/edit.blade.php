        ...
        <div class="col">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">{{ $master->name }} <small>{{ trans('master.edit') }}</small></h3>
                </div>
                ...
                <div class="panel-footer">
                    ...
                    {!! link_to_route('masters.show', trans('app.delete'), [$master->id], ['class' => 'btn btn-danger pull-right']) !!}
