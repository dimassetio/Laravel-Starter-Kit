...
@section('title', trans('sale.create'))

@section('content')
    <div class="row"><br>
        <div class="col-md-8">
            {!! Form::open(['route' => 'sales.store', 'id' => 'saleForm']) !!}
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">{{ trans('sale.create') }}</h3>
                </div>
                ...
                <div class="panel-footer">
                    {!! Form::submit(trans('sale.create'), ['class' => 'btn btn-primary']) !!}
